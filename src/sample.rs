...
pub struct Buffer {
    pub pid: usize,
    pub buf: VecDeque<(SamplePoint, Duration)>,
    pub last: SamplePoint,
}
...
impl Buffer {
    ...
    pub fn sample(&mut self, start: Instant) -> Result<()> {
        ...
        self.buf
            .push_back((&new_sample - &self.last, start.elapsed()));
...
fn get_user_sys_time(pid: usize) -> Result<SamplePoint> {
